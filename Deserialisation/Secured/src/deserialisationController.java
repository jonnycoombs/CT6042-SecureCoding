...
public class deserialisationController {
    ...
    public static Object deserializeFromFile(String inputName, Log logging) throws IOException {
        ...
        try {
            ...
            ObjectInputStream is = new LookAheadObjectInputStream(fileInputStream);
...
//            Logging to ensure if something malicious is processed it will show up in the logs so a developer can fix it
    ...
    public static void main (String[] args) throws IOException {
        ...
        deserializeFromFile("user.ser", logging);
