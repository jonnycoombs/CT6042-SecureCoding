...
<?php
// Checks for inputs from the GET function
if ( array_key_exists( "default", $_GET ) && !is_null ($_GET[ 'default' ]) ) {

	# Filtering allow list for permitted inputs
	switch ($_GET['default']) {
		case "Telugu":
		case "Hindi":
		case "Marathi":
		case "English":
			...
			break;
			#If the input from 'default' on the get is not one of these then it sets that location of the URL to English as default
		default:
